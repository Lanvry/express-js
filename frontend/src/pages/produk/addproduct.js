...
export default function ProdukAdd() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${API}/produk/store`, formData, {
                headers: {
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input type="text" required value={form.nama_produk}
                            ...
                            className="form-control" placeholder="Masukkan nama produk" />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" required value={form.harga}
                            ...
                            className="form-control" placeholder="Masukkan harga" />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" required value={form.stok}
                            ...
                            className="form-control" placeholder="Masukkan jumlah stok" />
                    </div>
