        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: "center", marginBottom: "32px" }}>
                    ...
                    <h1 style={{ fontSize: "24px", margin: 0 }}>Selamat Datang</h1>
                    <p style={{ color: "#64748b", fontSize: "14px", marginTop: "6px" }}>Silakan login untuk melanjutkan</p>
                </div>
                ...
                <p style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "#64748b" }}>
                    Belum punya akun? <Link to="/register" style={{ color: "#4f46e5", textDecoration: "none", fontWeight: 600 }}>Register</Link>
                </p>
            </div>
        </div>
    );
